...
d_pov_highcog <- dat_all_inr %>% filter(welloff_highcrcog==1) %>% 
  mutate(profile="welloff_highcrcog",
         resilience=1)
d_pov_lowcog <- dat_all_inr %>% filter(welloff_lowcrcog==1) %>% 
...
write.csv(table_util_imp_label_gain,"/Users/Kat/Library/CloudStorage/OneDrive-HarvardUniversity/abcd_study_with_kat/results/INR_quart_WELLOFF_cryst_cvXgb_table_util_Missing_label_gain.csv")
...
d_pov_highcrcog <- dat_all_inr_complete %>% filter(welloff_highcrcog==1) %>% 
  mutate(profile="welloff_highcrcog",
         resilience=1)
d_pov_lowcrcog <- dat_all_inr_complete %>% filter(welloff_lowcrcog==1) %>% 
  mutate(profile="welloff_lowcrcog",
         resilience=0)
...
write.csv(table_util_imp_label_gain,"/Users/Kat/Library/CloudStorage/OneDrive-HarvardUniversity/abcd_study_with_kat/results/INR_quart_WELLOFF_cryst_cvXgb_complete_cases_table_util_imp_label_gain.csv")
...
d_pov_highcrcog <- d %>% filter(welloff_highcrcog==1) %>% 
  mutate(profile="welloff_highcrcog",
         resilience=1)
d_pov_lowcrcog <- d %>% filter(welloff_lowcrcog==1) %>% 
  mutate(profile="welloff_lowcrcog",
         resilience=0)
...
write.csv(table_util_imp_label_gain,"/Users/Kat/Library/CloudStorage/OneDrive-HarvardUniversity/abcd_study_with_kat/results/INR_quart_WELLOFF_cryst_cvXgb_imputed1x_table_util_imp_label_gain.csv")
...
write.csv(table_util_imp_label_gain,"/Users/Kat/Library/CloudStorage/OneDrive-HarvardUniversity/abcd_study_with_kat/results/INR_quart_WELLOFF_cryst_cvSL_imputed1x_table_util_imp_label_gain.csv")
