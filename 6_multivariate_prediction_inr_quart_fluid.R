...
d_pov_highcog <- dat_all_inr %>% filter(pov_highflcog==1) %>% 
  mutate(profile="pov_highflcog",
         resilience=1)
d_pov_lowcog <- dat_all_inr %>% filter(pov_lowflcog==1) %>% 
...
write.csv(table_util_imp_label_gain,"/Users/Kat/Library/CloudStorage/OneDrive-HarvardUniversity/abcd_study_with_kat/results/INR_quart_fluid_cvXgb_table_util_Missing_label_gain.csv")
...
d_pov_highflcog <- dat_all_inr_complete %>% filter(pov_highflcog==1) %>% 
  mutate(profile="pov_highflcog",
         resilience=1)
d_pov_lowflcog <- dat_all_inr_complete %>% filter(pov_lowflcog==1) %>% 
  mutate(profile="pov_lowflcog",
         resilience=0)
...
write.csv(table_util_imp_label_gain,"/Users/Kat/Library/CloudStorage/OneDrive-HarvardUniversity/abcd_study_with_kat/results/INR_quart_fluid_cvXgb_complete_cases_table_util_imp_label_gain.csv")
...
write.csv(table_util_imp_label_gain,"/Users/Kat/Library/CloudStorage/OneDrive-HarvardUniversity/abcd_study_with_kat/results/INR_quart_fluid_cvXgb_imputed1x_table_util_imp_label_gain.csv")
...
write.csv(table_util_imp_label_gain,"/Users/Kat/Library/CloudStorage/OneDrive-HarvardUniversity/abcd_study_with_kat/results/INR_quart_fluid_cvSL_imputed1x_table_util_imp_label_gain.csv")
